...
## Your Mission
Generate SEO optimized content for 8 services in Dallas, TX. The site prioritizes nationwide replacement property identification and compliant guidance.
...
1) replacement-property-identification — Replacement Property Identification  Layout: classic
2) three-property-identification-strategy — Three Property Identification Strategy  Layout: timeline-first
3) two-hundred-percent-identification-strategy — 200 Percent Identification Strategy  Layout: faq-focused
4) ninety-five-percent-identification-strategy — 95 Percent Identification Strategy  Layout: comparison
5) reverse-exchange-coordination — Reverse Exchange Coordination  Layout: process-driven
6) improvement-exchange-planning — Improvement Exchange Planning  Layout: minimal
7) dst-placement-advisory — DST Placement Advisory  Layout: classic
8) multifamily-replacement-sourcing — Multifamily Replacement Sourcing  Layout: timeline-first
...
- Mention Dallas, TX once
- Follow the assigned layout sections

### 2. FAQs  4 to 6
- Include Dallas, TX in every answer
...
{ "disclaimer":"Example of the type of engagement we can handle", "serviceType":"[Service Name]", "location":"Dallas, TX", "scope":"...", "clientSituation":"...", "ourApproach":"...", "expectedOutcome":"...", "contactCTA":"Contact us to discuss your situation in Dallas, TX. We can share references upon request." }
