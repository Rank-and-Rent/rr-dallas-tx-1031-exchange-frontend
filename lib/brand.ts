...
export function getBrand() {
  // Using 1031 Exchange of Dallas colors (1031 Exchange of Dallas theme)
  const COLORS = {
    primary: '#D9A441', // Texas Gold
    secondary: '#153243', // Midnight Steel
    dark: '#153243', // Dark background
  };
  ...
  return {
    ...
    call_phone: COMPANY_PHONE,
    call_phone_plain: COMPANY_PHONE_DIGITS,
    site_cta_label: "Go To Site",
    site_url: SITE_URL,

    // Address and footer
    address_line: `Serving investors across ${PRIMARY_CITY}, ${PRIMARY_STATE_ABBR}`,
    ...
    service_area: `Serving ${PRIMARY_CITY} and North Texas`,
