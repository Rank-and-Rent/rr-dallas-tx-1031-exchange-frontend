...
function getProjectTypeFromSite(site: string): string {
  const siteToProjectType: Record<string, string> = {
    'rr-dallas-tx-1031-exchange': '1031 Exchange',
  }
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.1031exchangedallas.com'
    ...
    const payload = {
      ...
      _meta: {
        site: 'rr-dallas-tx-1031-exchange',
        route: '/api/lead',
      },
    }
